...
// Example of a simple crawler that searches for RSS feeds under domain
public class RSSFeedFinderApp {

    private final String BASE_DOMAIN = "https://www.hs.fi/rss-syotteet/";
    ...
    private void doMain() throws Exception {
        ...
        RSSFeedCrawler c = new RSSFeedCrawler(config, BASE_DOMAIN);
    ...
    public static void main(String[] args) {
        try {
            RSSFeedFinderApp main = new RSSFeedFinderApp();
            main.doMain();
        } catch (Exception ex) {
            ex.printStackTrace();
        }
